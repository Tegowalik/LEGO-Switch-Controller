...
### Configuration Part
Depending on your actual switch layout, you need to add a few lines to the program right below the line '''python configure your switch layout here'''
...
|-|-|-|
| 1 Sensor + 1 Switch | | '''python 
# test
'''
|
| 1 Sensor + 2 Switches | | '''python # another test'''|
